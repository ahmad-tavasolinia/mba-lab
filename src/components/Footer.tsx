  ...
  return (
    <footer className="border-t border-rule dark:border-dark-rule">
      <div className="mx-auto max-w-content px-6 py-6 md:px-10">
        ...
        <div className="mt-6 flex flex-col gap-2 border-t border-rule pt-4 text-xs text-ink/40 dark:border-dark-rule dark:text-dark-soft/50 sm:flex-row sm:items-center sm:justify-between">
