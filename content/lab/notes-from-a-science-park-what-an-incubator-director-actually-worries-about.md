...
summary: "A field interview with the deputy director of a regional tech park — on what actually makes an incubator work, and where this one still falls short."
centralQuestion: "Once you strip away the funding and the branding, what does an incubator actually need to produce to be worth having?"
keyIdeas:
  - "The park's real filter isn't technical merit — it's whether a founder has any real understanding of whether anyone would actually buy the thing. Roughly one in three applicants gets in, filtered on that basis."
  - "What predicts survival in the program isn't a business background — most of the team came from engineering or humanities — it's an appetite for self-directed growth over a five-to-ten-year horizon, since a resource-constrained public institution can't hold anyone's hand."
  - "The park's actual value proposition isn't office space or funding — it's density: shared equipment, shared talent pools, informal investor networks, and referrals that happen as a byproduct of physical proximity, not because anyone scheduled them."
  - "Density alone doesn't guarantee collaboration — it depends on who you put in the building. Outside Tehran, there's a cultural pull toward isolated, private work that's stronger among technical and engineering people than among creative ones."
  - "The most common unsolved problem founders bring in isn't technical at all — it's people management: hiring under pressure, motivating a difficult employee, knowing when and how to let someone go."
  - "There's no formal broker function matching unsolved technical problems with outside expertise, and no one with the specific skill of knowing how to leverage existing regulation to a company's advantage — both structural gaps in the regional ecosystem."
connections: []
openQuestions:
  - "What would it actually take to build the peer case-discussion mechanism he agreed was missing — and would a resource-constrained public institution ever be able to run it consistently?"
  - "If direct financial subsidies tend to slow young companies down, what does well-designed early-stage support look like instead, beyond a narrow set of facility-type help?"
finalPerspective: "An institution can have the office space, the subsidies, and the mandate, and still fail at its actual job if there's no mechanism for one founder's hard-won answer to reach the next founder asking the same question."
sources: []
---
