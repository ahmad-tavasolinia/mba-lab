...
keyIdeas:
  - "A mid-calorie product risks sitting in a gap wanted by neither group: people who don't care about calories, and people who already accepted diet cola's taste."
  - "There is a real third group worth targeting: people who care about sugar but specifically dislike diet cola's taste, and left the category entirely rather than switch to Diet Pepsi."
  - "Strong blind taste tests, strong market tests, and a fast 1% share at launch all measure trial, not repeat purchase — and trial is driven heavily by free sampling regardless of whether the product is actually good."
  - "The real test of a product built on curiosity is always what happens after the free samples run out."
connections: []
openQuestions:
...
finalPerspective: "Being right the first time is useful. Staying right when the data starts arguing with you is the harder skill, and the one that actually gets tested."
sources: []
---
