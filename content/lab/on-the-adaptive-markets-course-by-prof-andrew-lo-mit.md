...
Usually, the market behaves more rationally when people are making decisions independently. However, as soon as they start imitating each other, herd-like behavior begins. When independence fades away, the ecosystem gets sick and bubbles start to form. Individuals start thinking, "Everyone is buying, so I should buy as well." At that point, the decision is no longer really based on independent judgment; it is based on what everyone else is doing.

So, one lesson I learned is that these behaviors are not bugs in the system, but the rules of the game.

Classic financial models are not necessarily wrong; they simply aren't complete. What they lack is real human behavior. Therefore, the important thing is not to completely reject a model, but to understand when it works and when it doesn't.
...
And why is this so important? Because, as I mentioned earlier, the era we live in is characterized by constant change and volatility. Great rewards and remarkable success will belong to managers and leaders who can make decisions in the face of uncertainty, where there is no historical data or formula to help them, and where they have to rely on a deep understanding of human psychology and system dynamics to navigate the organization's ship through the storm.
